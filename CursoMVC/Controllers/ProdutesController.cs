...
{
    public class ProdutesController : Controller
    {
        private readonly Context _context;

        public ProdutesController(Context context)
        {
            _context = context;
        }
